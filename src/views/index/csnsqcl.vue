    ...
    <div class="form">
      ...
      <div class="formbox">
        ...
        <el-form
          ...
          label-position="left"
        >
          <el-form-item label="尿尿素：" prop="nns">
            <el-input
              v-model.trim="form.nns"
              type="number"
              placeholder="请输入"
            >
          ...
          <el-form-item label="尿液收集起始时血尿素：" prop="nysjqssxns">
            <el-input
              v-model.trim="form.nysjqssxns"
              type="number"
              placeholder="请输入"
            >
              <p slot="suffix">mmol/L</p>
          ...
          <el-form-item label="尿液收集结束时血尿素：" prop="nysjjssxns">
            <el-input
              v-model.trim="form.nysjjssxns"
              type="number"
              placeholder="请输入"
            >
              <p slot="suffix">mmol/L</p>
  ...
  methods: {
    onSubmit(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
           this.total = this.$api.RRUCFormula(this.form);
        } else {
          return false;
        }
      });
